...
-include vendor/MTS/x2605/BoardConfigVendor.mk

# use these headers 
TARGET_SPECIFIC_HEADER_PATH := device/MTS/x2605/include
...
# TARGET_KERNEL_SOURCE := kernel/MTS/x2605
# TARGET_KERNEL_ARCH := arm64
# TARGET_KERNEL_HEADER_ARCH := arm64
# TARGET_KERNEL_CONFIG := cyanogenmod_x2605_defconfig
# TARGET_KERNEL_CROSS_COMPILE_PREFIX := aarch64-linux-android-
# MTK_APPENDED_DTB_SUPPORT := yes
# BOARD_KERNEL_IMAGE_NAME := Image.gz-dtb
 
# prebuild kernel as fallback
TARGET_PREBUILT_KERNEL := device/MTS/x2605/prebuilt/kernel
...
# system.prop
TARGET_SYSTEM_PROP := device/MTS/x2605/system.prop

# CyanogenMod Hardware Hooks
BOARD_HARDWARE_CLASS := device/MTS/x2605/cmhw/
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/MTS/x2605/bluetooth
...
BOARD_EGL_CFG := device/MTS/x2605/egl.cfg
BOARD_EGL_WORKAROUND_BUG_10194508 := true

# SELinux
BOARD_SEPOLICY_DIRS := \
       device/MTS/x2605/sepolicy
